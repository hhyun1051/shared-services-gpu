...
echo '';
python3 -c \"import os; from huggingface_hub import snapshot_download; snapshot_download('${MODEL_NAME}', token=os.getenv('HF_TOKEN'))\";
echo '';
